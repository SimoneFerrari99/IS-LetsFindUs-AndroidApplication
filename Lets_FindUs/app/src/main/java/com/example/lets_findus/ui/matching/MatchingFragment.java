...
import com.example.lets_findus.utilities.DateWithArithmetic;
    ...
    public void filterItems(Map<String, String> filterOptions){
        ...
        while (mpIterator.hasNext()) {
            ...
            switch (filterOptions.get("hour")) {
                case "00.00 - 04.00":
                    if(DateTimeComparator.getDateOnlyInstance().compare(elem.meeting.date, DateWithArithmetic.subtractDays(Calendar.getInstance(Locale.ITALY).getTime(), 0 )) != 0)
                        mpIterator.remove();
                    break;
                case "04.00 - 08.00":
                    if(DateTimeComparator.getDateOnlyInstance().compare(elem.meeting.date, DateWithArithmetic.subtractDays(Calendar.getInstance(Locale.ITALY).getTime(), 1 )) != 0)
                        mpIterator.remove();
                    break;
                case "08.00 - 12.00":
                    if(DateTimeComparator.getDateOnlyInstance().compare(elem.meeting.date, DateWithArithmetic.subtractDays(Calendar.getInstance(Locale.ITALY).getTime(), 2 )) != 0)
                        mpIterator.remove();
                    break;
                case "12.00 - 16.00":
                    if(DateTimeComparator.getDateOnlyInstance().compare(elem.meeting.date, DateWithArithmetic.subtractDays(Calendar.getInstance(Locale.ITALY).getTime(), 3 )) != 0)
                        mpIterator.remove();
                    break;
                case "16.00 - 20.00":
                    if(DateTimeComparator.getDateOnlyInstance().compare(elem.meeting.date, DateWithArithmetic.subtractDays(Calendar.getInstance(Locale.ITALY).getTime(), 4 )) != 0)
                        mpIterator.remove();
                    break;
                case "20.00 - 24.00":
                    if(DateTimeComparator.getDateOnlyInstance().compare(elem.meeting.date, DateWithArithmetic.subtractDays(Calendar.getInstance(Locale.ITALY).getTime(), 5 )) != 0)
                        mpIterator.remove();
                    break;
            }
        }
